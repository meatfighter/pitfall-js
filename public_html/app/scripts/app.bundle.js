...
function renderScreen(ctx) {
    ...
    for (let dir = 0; dir < 2; ++dir) {
        for (let i = 0; i < 8; ++i) {
            ctx.drawImage(_graphics__WEBPACK_IMPORTED_MODULE_1__.harrySprites[dir][i], 8 * i, 8 + 22 * dir);
        }
    }
    for (let i = 0; i < 11; ++i) {
        ctx.drawImage(_graphics__WEBPACK_IMPORTED_MODULE_1__.charSprites[0x0C][i], 8 * i, 0);
    }
}
...
var Resolution;
(function (Resolution) {
    Resolution[Resolution["WIDTH"] = 160] = "WIDTH";
    Resolution[Resolution["HEIGHT"] = 228] = "HEIGHT";
})(Resolution || (Resolution = {}));
var PhysicalDimensions;
(function (PhysicalDimensions) {
    PhysicalDimensions[PhysicalDimensions["WIDTH"] = 4] = "WIDTH";
    PhysicalDimensions[PhysicalDimensions["HEIGHT"] = 3] = "HEIGHT";
...
function enter() {
    ...
    screenCanvas.width = _graphics__WEBPACK_IMPORTED_MODULE_3__.Resolution.WIDTH;
    screenCanvas.height = _graphics__WEBPACK_IMPORTED_MODULE_3__.Resolution.HEIGHT;
